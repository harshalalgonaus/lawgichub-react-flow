      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-legal-navy mb-4">
            Why Choose <br /> Lawgichub?
          </h2>
        </div>
        <div className="grid lg:grid-cols-2 gap-12 items-start mb-16">
          {/* Testimonials Block */}
          <div>
            <h2 className="text-2xl font-bold text-legal-navy mb-6 text-center">
              Testimonial's
            </h2>
              ...
              <div className="overflow-hidden rounded-lg">
                ...
                >
                  {testimonials.map((testimonial, index) => (
                    <div key={index} className="w-full flex-shrink-0 px-2" style={{ minWidth: '100%' }}>
                      <Card className="p-6 bg-white border border-legal-light-grey/30 h-auto">
                        <div className="space-y-4">
                          ...
                          <blockquote className="text-lg text-legal-navy leading-relaxed word-wrap">
                            {testimonial.quote}
                          </blockquote>
                          <div className="flex items-center space-x-3 pt-4">
                            ...
                            <div>
                              ...
                              <div className="text-sm text-legal-grey">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-legal-brown">
